...
curl -L -o kokoro-v1.0.onnx https://huggingface.co/hexgrad/Kokoro-82M/resolve/main/kokoro-v1.0.onnx

# Download voices binary file
curl -L -o voices-v1.0.bin https://huggingface.co/hexgrad/Hexgrad/Kokoro-82M/resolve/main/voices-v1.0.bin
```
