...
class AgentBuilderInput(BaseModel):
    ...
    role: str = Field(..., description="The role of the sub-agent")
    goal: str = Field(..., description="The goal of the sub-agent")
    backstory: str = Field(..., description="The backstory of the sub-agent")
